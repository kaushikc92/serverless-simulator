...
class FIFODAGScheduler{
    public static double eps = 0.0000001;
    List<DAG> DAGs;
    Cluster cluster;
    public FIFODAGScheduler(List<DAG> DAGs, Cluster cluster)
    {
        this.DAGs = DAGs;
    ...
    {
        if (s1.dag.timeStamp - s2.dag.timeStamp > 0)
            return 1;
        else if (s1.dag.timeStamp - s2.dag.timeStamp < 0)
            return -1;
        else
        {
